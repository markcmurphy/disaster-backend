...
class SurvivorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survivor" do
    assert_difference('Survivor.count') do
      post survivors_url, params: { survivor: { lat: @survivor.lat, lng: @survivor.lng, name: @survivor.name, number: @survivor.number } }, as: :json
    end
  ...
  test "should update survivor" do
    patch survivor_url(@survivor), params: { survivor: { lat: @survivor.lat, lng: @survivor.lng, name: @survivor.name, number: @survivor.number } }, as: :json
    assert_response 200
  end
